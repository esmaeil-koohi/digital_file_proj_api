...
class UsernameValidator(RegexValidator):
    ...
    message = 'Enter a valid username starting a-z. '
...
class IBanNumberValidator(RegexValidator):
    regex = '^[a-zA-Z]{2}[0-9]{2}[a-zA-Z0-9]{4}[0-9]{4}[0-9]{7}([a-zA-Z0-9]?){0,16}$'
...
validate_id_number = IBanNumberValidator()
validate_iban = IBanNumberValidator()
